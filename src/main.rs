...
fn main() {
    let resp: String =
        reqwest::get("https://api.chess.com/pub/leaderboards").expect("Could not connect.").text().expect("Could not connect.");
    ...
    println!("Today's top chess player is {} with a sccore of {}.\nCheck them out at {}", name,score,url);
